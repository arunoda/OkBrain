...
export default function ChatLayout({ children }: ChatLayoutProps) {
  ...
  // Check if we're viewing a document or the memory page (should hide chat input)
  const isDocumentPage = pathname.startsWith('/doc/');
  const isMemoryPage = pathname === '/me';

  const shouldHideInput = isDocumentPage || isMemoryPage;
            ...
            <div className="input-wrapper">
              ...
              {currentModel?.capabilities.fileUpload && (
                <button
                  ...
                  title={isUploading ? 'Uploading...' : 'Attach file (image or PDF)'}
                >
                  {isUploading ? (
