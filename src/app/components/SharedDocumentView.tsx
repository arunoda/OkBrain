...
import { Globe, Camera, Printer } from "lucide-react";
...
export default function SharedDocumentView({ title, content, snapshotMessage, snapshotDate }: SharedDocumentViewProps) {
  return (
