...
export default function ChatView({
  ...
  const {
    ...
    documentContexts, locationContext,
    sendMessageRef, stopStreamingRef, focusInputRef,
    streamingMessageRef, messagesEndRef, thoughtsContainerRef,
    initialStreamingMessageId, initialStreamingThoughts,
    initialActiveJobId, initialLastSeq,
  });
  ...
  }, [initialConversationId, initialMessages, initialConversation, setAiProvider, setResponseMode, searchParams, shouldScroll, computedInitialMessages]);
