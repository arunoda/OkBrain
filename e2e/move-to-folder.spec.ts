...
import { loadTestEnv, cleanupTestDb, verifyTestDb, setupPageWithUser } from './test-utils';
...
// Insert a message directly into the DB so the chat header (with menu) is visible
function insertMessage(conversationId: string) {
